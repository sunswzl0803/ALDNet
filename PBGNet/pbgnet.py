...
from nets.pbgnet import PBGnet as pbgnet
...
class PBGnet(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        "model_path"    : 'logs/epxxx-lossxxx-val_lossxxx.pth',
        #--------------------------------#
        #   所需要区分的类的个数+1
        #--------------------------------#
        "num_classes"   : 2,
    ...
    def generate(self, onnx=False):
        self.net = pbgnet(num_classes = self.num_classes, backbone=self.backbone)
    ...
    def detect_image(self, image, count=False, name_classes=None):
        ...
        with torch.no_grad():
            ...
            # print('第一阶段分割所需时间：', elapsed_time, '秒')
        #---------------------------------------------------------#
        #   计数
        #---------------------------------------------------------#
        if count:
